#!/bin/bash
# PolyServe router with gated round robin policy
...
python -m sglang_router.launch_router \
  ...
  --worker-urls \
    ...
    http://0.0.0.0:31007 \
    http://0.0.0.0:31008 \
  --scheduler-config-file /sgl-workspace/sglang/eval/eval_utils/polyserve/polyserve/scheduler_config_slo_aware_ttft.json