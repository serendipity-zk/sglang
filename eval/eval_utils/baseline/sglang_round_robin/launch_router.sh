#!/bin/bash
# SGLang Round Robin baseline router - round robin policy
...
python -m sglang_router.launch_router \
  ...
  --worker-urls \
    ...
    http://0.0.0.0:31007 \
    http://0.0.0.0:31008 \
  --scheduler-config-file /sgl-workspace/sglang/eval/eval_utils/baseline/sglang_round_robin/scheduler_config_eager.json
